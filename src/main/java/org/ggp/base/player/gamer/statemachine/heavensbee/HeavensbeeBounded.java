...
public final class HeavensbeeBounded extends SampleGamer {
	private Logger log = null;
	private int depth_limit = 0;
	private long hard_deadline;

	public HeavensbeeBounded() throws SecurityException, IOException {
...
//		}
//
//	    log.info("Starting instance of " + ClassName.class.getName());
	}
	...
	public int maxscore(Role role, MachineState state, int depth) throws GoalDefinitionException, MoveDefinitionException, TransitionDefinitionException
	{
		...
		{
			log.log( Level.FINE, "{0} is >= depth limit {1}", new Object[]{depth, depth_limit} );
			return 0;
		}
